...
const Footer = () => {
  return (
    <div className="bg-gray-100 px-[200px] h-[60vh] mt-[50px]">
      ...
      <div>
        <img src="/logofinal-removebg-preview.png" alt="" height={200} width={200} />
      </div>

      <div>
        <h3 className="text-xl font-semibold">Navighează rapid</h3>
        <ul className="mt-2 space-y-2">
          <li className="hover:underline">Acasă</li>
          <li className="hover:underline">Informații utile</li>
          <li className="hover:underline">Donează</li>
      ...
      <h3 className="text-xl font-semibold">Contactează-ne</h3>
      <p className="mt-2">Calea Dorobanți 15-17, sector 1, București</p>
      <p className="mt-2">Tel: (+40) 729-652-706</p>
      <p className="mt-2">Email: bloodchain.salveazavieti@gmail.com</p>

      </div>
      </div>
      <div className="mt-8 border-t border-red-800 pt-4 text-center">
        <p>&copy; 2025 BloodChain. Toate drepturile rezervate.</p>
